...
class CcaptureImageDB : public CRecordset
{
public:
	CcaptureImageDB(CDatabase* pDatabase = NULL);
	DECLARE_DYNAMIC(CcaptureImageDB)
...
class CwordFilter : public CRecordset
{
public:
	CwordFilter(CDatabase* pDatabase = NULL);
	DECLARE_DYNAMIC(CwordFilter)
